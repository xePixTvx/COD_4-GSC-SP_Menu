...
give_loadout()
{
	...
	{
		level.player giveWeapon("USP");//mod cause of default_weapon bug
		level.player giveMaxAmmo("USP");//mod cause of default_weapon bug
		level.player switchToWeapon("USP");//mod cause of default_weapon bug
